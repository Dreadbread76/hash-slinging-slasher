...
| family gap filling | 1 | 37 | 293 | 3,493,254 | 11,922 | 654 | 103,111 | 2026-08-19 | 2026-08-29 | spent |
...
| image siblings of confirmed materials | 1 | 94 | 5,731 | 163,767,219 | 28,575 | 393 | 347,629 | 2026-08-19 | 2026-08-29 | spent |
...
| image channel completion | 1 | 64 | 1,340 | 159,395,554 | 118,951 | 5,159 | 847,055 | 2026-08-20 | 2026-08-29 | spent |
...
| sound beginnings the 700 ceiling drops | 1 | 2 | 117 | 145,743,867,360 | 1,245,674,080 | 1,235,117,520 | 1,235,117,520 | 2026-08-29 | 2026-08-29 | live |
...
412 distinct methods, run 472 ways between them, across 1736 runs. `names` is what each run
...
| Method 25 on Black Ops 4, every segment depth | *All-boundary cores x uncarried endings* is the most productive change recorded here and returned 2,553 names on Cold War, so the depths were swept against Black Ops 4's own 158,563 unnamed ids to see whether the same seam runs through the other title. It does not. **Depths 1, 2, 3, 4 and 5 at 100,000 endings each: 0, 0, 4, 0, 0** -- four names for roughly 900 billion candidates, and `derive_closure` turned those four into 7. Not a plumbing failure: the same generator, the same lists and the same plan return names on Cold War, and depth 3 landing 4 shows the candidates are well formed. It is the standing Black Ops 4 result in a new place -- the pool's unnamed remainder is not built from the pieces its named names are built from -- and it now covers the non-sound types, where the earlier zeros were all `sound_asset`. Read it as a warning against porting a Cold War seam to Black Ops 4 on the strength of its Cold War yield. |
